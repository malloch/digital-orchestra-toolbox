...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 225.0, 164.0, 20.0 ],
					"text" : "defaults to constant leak of 1"
				}
...
,
					"patching_rect" : [ 30.0, 120.0, 134.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 255.0, 195.0, 184.0, 47.0 ],
					"text" : "dot.leakyintegrator2 @expression y=(abs(sin(x/10))) @min -100 @max 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 501.0, 15.0, 4.0, 371.0 ]
				}
...
, 			{
				...
				"bootpath" : "/Users/jocal/Documents/DOT/branches/v2_max5/toolbox/filters/dot.leakyintegrator",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
