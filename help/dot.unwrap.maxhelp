...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 150.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 400.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "dot.wrap"
				}
...
,
					"patching_rect" : [ 165.0, 230.0, 39.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 145.0, 157.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 200.0, 156.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 182.0, 321.0, 81.0, 20.0 ],
					"style" : "",
					"text" : "unwrapped",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 321.0, 54.0, 20.0 ],
					"style" : "",
					"text" : "original",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 165.0, 180.0, 103.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 45.0, 125.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "metro 1000"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../Max 7/Packages/DOT/help",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "dot.unwrap.maxpat",
				"bootpath" : "~/Documents/Software/DOT/toolbox/filters/dot.unwrap",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
