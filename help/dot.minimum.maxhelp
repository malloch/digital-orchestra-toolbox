...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.0, 135.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "dot.float.inf"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 125.0, 120.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Like the minimum object, but accepts INF, -INF as argument or min value.",
