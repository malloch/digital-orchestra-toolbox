...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "drag number box to test for peak"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 322.0, 103.5, 100.0, 25.0 ],
					"style" : "",
					"text" : "set old peak"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Like the peak object, but doesn't assume the initial value.",
