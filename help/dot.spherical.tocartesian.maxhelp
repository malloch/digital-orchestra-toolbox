...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Converts spherical coordinates to Cartesian representation.",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 375.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 315.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 45.0, 225.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 150.0, 75.0, 100.0, 100.0 ],
					"rightmargin" : 4,
					"rightvalue" : 128,
					"style" : "",
					"topmargin" : 4,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 135.0, 144.0, 20.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.0, 165.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 75.0, 100.0, 100.0 ],
					"rightmargin" : 4,
					"rightvalue" : 128,
					"style" : "",
					"topmargin" : 4,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 240.5, 219.5, 54.5, 219.5 ],
					"source" : [ "obj-13", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 135.5, 188.0, 116.5, 188.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 159.5, 189.0, 178.5, 189.0 ],
					"source" : [ "obj-3", 0 ]
				}
