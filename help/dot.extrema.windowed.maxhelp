...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Outputs the minimum and maximum value received with the last n samples. Also outputs the order of the extrema in the window.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 300.0, 180.0, 47.0 ],
					"style" : "",
					"text" : "3rd outlet outputs order of extrema (0 if maximum occurs first, 1 if minimum occurs first)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 390.0, 107.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 375.0, 180.0, 96.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 390.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "dot.extrema"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 420.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 450.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
