...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Process the data from a Wii Motion Plus and remove gyro bias.",
...
,
					"patching_rect" : [ 45.0, 285.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 150.0, 291.0, 47.0 ],
					"style" : "",
					"text" : "input: 6 bytes as encoded by the Wii Motion Plus\noutput: 3-axis angular velocity in degrees/sec with gyro bias removed."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 105.0, 141.0, 22.0 ],
					"style" : "",
					"text" : "dot.device.wiimotionplus"
				}
