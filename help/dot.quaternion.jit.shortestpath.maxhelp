...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "dot.quaternion.jit.line @ramptime 2000 @shortest 0"
								}
...
,
					"patching_rect" : [ 180.0, 225.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 45.0, 315.0, 105.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 270.0, 99.0, 22.0 ],
									"style" : "",
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-31", 0 ],
									"midpoints" : [ 39.5, 303.0, 54.5, 303.0 ],
									"source" : [ "obj-35", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 255.0, 140.0, 105.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 255.0, 140.0, 105.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Adjust a stream of quaternion matrices to eliminate unnecessary rotations.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 180.0, 195.0, 169.0, 22.0 ],
					"style" : "",
					"text" : "dot.quaternion.jit.shortestpath"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 39.5, 183.0, 189.5, 183.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"name" : "dot.quaternion.jit.shortestpath.maxpat",
...
, 			{
				"name" : "dot.quaternion.jit.line.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/Digital Orchestra Toolbox/patchers",
				"patcherrelativepath" : "../patchers",
				"type" : "JSON",
				"implicit" : 1
