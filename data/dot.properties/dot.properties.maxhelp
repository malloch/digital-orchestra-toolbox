...
,
		"rect" : [ 683.0, 148.0, 533.0, 401.0 ],
		"bglocked" : 0,
		"defrect" : [ 683.0, 148.0, 533.0, 401.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 210.0, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 45.0, 477.0, 55.0 ],
					"text" : "regexp wrapper for parsing message properties expressed in the form @<label> <data>. Second outlet outputs number of properties. Third outlet outputs unmatched parts of the input string/unmatched strings."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 210.0, 91.0, 20.0 ],
