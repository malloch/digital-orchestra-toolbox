...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 90.0, 218.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 375.0, 166.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 330.0, 255.0, 131.0, 20.0 ],
					"text" : "dot.std 100 @Bessel 0"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 125.0, 100.0, 33.5, 20.0 ],
									"text" : "+ 0."
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 195.0, 235.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 150.0, 218.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.0, 195.0, 79.0, 20.0 ],
					"text" : "dot.std 100"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 219.5, 186.0, 143.5, 186.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 54.5, 176.0, 159.5, 176.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../meta",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "dot.std.maxpat",
				"bootpath" : "/Users/jocal/Documents/DOT/branches/v2_max5/toolbox/statistics/dot.std",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"bootpath" : "/Users/jocal/Documents/DOT/branches/v2_max5/toolbox/filters/dot.smooth",
				"patcherrelativepath" : "../../filters/dot.smooth",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
