...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 165.0, 258.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 240.0, 258.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Calculate the inverse of a quaternion"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 54.5, 152.0, 308.5, 152.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 54.5, 227.0, 308.5, 227.0 ],
					"source" : [ "obj-225", 0 ]
				}
...
, 			{
				"name" : "dot.quaternion.inverse.maxpat",
				"bootpath" : "/Users/jocal/Documents/DOT/branches/v2_max5/toolbox/quaternions/dot.quaternion.inverse",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "dot.quaternion.conjugate.maxpat",
				"bootpath" : "/Users/jocal/Documents/DOT/branches/v2_max5/toolbox/quaternions/dot.quaternion.conjugate",
				"patcherrelativepath" : "../dot.quaternion.conjugate",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "dot.quaternion.multiply.maxpat",
				"bootpath" : "/Users/jocal/Documents/DOT/branches/v2_max5/toolbox/quaternions/dot.quaternion.multiply",
				"patcherrelativepath" : "../dot.quaternion.multiply",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
