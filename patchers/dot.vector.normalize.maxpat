...
, 			{
				"box" : 				{
					"comment" : "(float or list) Normalized output",
					"hint" : "(float or list) Normalized output",
					"id" : "obj-3",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "(int, float, or list) Input to normalize",
					"hint" : "(int, float, or list) Input to normalize",
					"id" : "obj-1",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 54.5, 182.0, 204.5, 182.0 ],
					"source" : [ "obj-15", 0 ]
				}
