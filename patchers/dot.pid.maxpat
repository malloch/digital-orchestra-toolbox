...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 150.0, 120.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 150.0, 75.0, 85.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 330.0, 154.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.0, 225.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "dot.aggregate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.0, 285.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 270.0, 255.0, 109.0, 22.0 ],
					"style" : "",
					"text" : "* 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.0, 255.0, 109.0, 22.0 ],
					"style" : "",
					"text" : "* 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 350.0, 45.0, 20.0 ],
					"style" : "",
					"text" : "control"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 125.0, 47.0, 20.0 ],
					"style" : "",
					"text" : "error"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.0, 195.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "t f f"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 39.5, 108.0, 99.5, 108.0 ],
					"order" : 0,
					"source" : [ "obj-13", 0 ]
				}
